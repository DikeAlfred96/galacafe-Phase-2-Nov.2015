		...
		<?php if ($this->session->userdata('is_logged_in_admin')) { ?>
			...
			<p class="footer_link_s"><a href="<?php echo base_url(); ?>control_panel/view_dishesmodify">菜肴操作</a> | <a href="<?php echo base_url(); ?>control_panel/view_analytics">报告</a> | <a href="<?php echo base_url(); ?>control_panel/view_bbq_only">烤串</a> | <a href="<?php echo base_url(); ?>control_panel/view_fried_only">炸/烫串</a></p>
		<?php } else { ?>
