	    ...
	    <div id="kitchen" class="bbq_only">
		    <div class="catagory">
				...
				<?php foreach ($fetch_dish->result() as $items):
					...
					$sql_dish_qty = "SELECT dishQuantity, dishChiName, dishStatus, tableId, orderAlias, orderTime, catId, dishAlphaId FROM view_kitchen WHERE dishStatus=0 AND catId=6 AND dishChiName='{$currentName}' ORDER BY dishAlphaId DESC, dishQuantity DESC;";
